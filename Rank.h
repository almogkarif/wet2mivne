...
void RankTreeToArr(Node<T, RankFunc>* root, Node<T, RankFunc>* arr[], int* loc);

template<class T, class Pred, class RankFunc>
void margeNodeArr(Node<T, RankFunc>* a_arr[], int a_size, Node<T, RankFunc>* b_arr[], int b_size, 
...
template<class T, class Pred, class RankFunc>
void storeInOrder( Node<T, RankFunc>* root, T arr[], int *ind)
{
    if( root == nullptr)
        return;
...
template<class T, class Pred, class RankFunc>
void margeNodeArr(Node<T, RankFunc>* a_arr[], int a_size, Node<T, RankFunc>* b_arr[], int b_size, Node<T, RankFunc>* ab_arr[], Pred cond)
{
    int it_a =0;
    int it_b =0;
    int it_ab =0;
